...
namespace identityServer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email.ToLowerInvariant() }; //, FirstName = model.FirstName };
                ...
                if (result.Succeeded)
                {
                    ...
                    var adress_json = JsonConvert.SerializeObject(adress);
                                    
                    await  _userManager.AddClaimsAsync(user, new Claim[]{
                        new Claim(JwtClaimTypes.Name, model.FirstName + " "+ model.FamilyName),
                        ...
                        new Claim(JwtClaimTypes.Address, @adress_json, IdentityServer4.IdentityServerConstants.ClaimValueTypes.Json)
                        });
